...
class PropertyController extends Controller
{
    ...
    { 
        ...
        if(isset($image)){
            ...
            $propertyimage = Image::make($image)->save('propertyimage.jpg');
        ...
        if($gallary)
        {
            foreach($gallary as $images)
            {
                ...
                $propertyimage = Image::make($images)->save('propertyimage.jpg');
        ...
        if($gallary){
            foreach($gallary as $images){
                if(isset($images))
                {
                    ...
                    $propertyimage = Image::make($images)->save('gallaryimage.jpg');
                    Storage::disk('public')->put('property/gallery/'.$galimage['name'], $propertyimage);
