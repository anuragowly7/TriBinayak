...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($image)){
            ...
            $propertyimage = Image::make($image)->save('property-image.jpg');
        ...
        if(isset($floor_plan)){
            ...
            $propertyfloorplan = Image::make($floor_plan)->save('floor_plan.jpg');
        ...
        if($gallary)
        {
            foreach($gallary as $images)
            {
                ...
                $propertyimage = Image::make($images)->save('property-image.jpg');
        ...
        if($gallary){
            foreach($gallary as $images){
                if(isset($images))
                {
                    ...
                    $propertyimage = Image::make($images)->save('gallery-images.jpg');
                    Storage::disk('public')->put('property/gallery/'.$galimage['name'], $propertyimage);
